...
## Scope
This agents document is part of Vibestack, a universal context operating system for AI engineering. It provides deterministic guidance for accessibility.
...
2. Load required rules and workflows.
3. Produce bounded artifact.
4. Report risks and persist decisions.
