...
## Purpose
Production-grade guidance for api in the Vibestack ecosystem.

## Scope
This agents document is part of Vibestack, a universal context operating system for AI engineering. It provides deterministic guidance for api.
