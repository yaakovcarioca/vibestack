...
## Purpose
Production-grade guidance for portability in the Vibestack ecosystem.

## Scope
This core document is part of Vibestack, a universal context operating system for AI engineering. It provides deterministic guidance for portability.
