...
## Purpose
Production-grade guidance for skills in the Vibestack ecosystem.

## Scope
This docs document is part of Vibestack, a universal context operating system for AI engineering. It provides deterministic guidance for skills.
