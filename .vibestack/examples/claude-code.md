...
## Purpose
Production-grade guidance for claude code in the Vibestack ecosystem.

## Scope
This examples document is part of Vibestack, a universal context operating system for AI engineering. It provides deterministic guidance for claude code.
...
## Example Flow
1. Load core context.
2. Select role-specific agent and skills.
3. Execute workflow under rules.
4. Persist outcomes to memory modules.
