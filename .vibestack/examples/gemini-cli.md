...
## Purpose
Production-grade guidance for gemini cli in the Vibestack ecosystem.

## Scope
This examples document is part of Vibestack, a universal context operating system for AI engineering. It provides deterministic guidance for gemini cli.
