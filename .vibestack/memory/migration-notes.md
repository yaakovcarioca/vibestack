...
## Purpose
Production-grade guidance for migration notes in the Vibestack ecosystem.

## Scope
This memory document is part of Vibestack, a universal context operating system for AI engineering. It provides deterministic guidance for migration notes.
