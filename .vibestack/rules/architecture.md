...
## Purpose
Production-grade guidance for architecture in the Vibestack ecosystem.

## Scope
This rules document is part of Vibestack, a universal context operating system for AI engineering. It provides deterministic guidance for architecture.
