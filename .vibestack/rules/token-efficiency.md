...
## Purpose
Production-grade guidance for token efficiency in the Vibestack ecosystem.

## Scope
This rules document is part of Vibestack, a universal context operating system for AI engineering. It provides deterministic guidance for token efficiency.
...
## Enforcement
- Non-compliant pull requests require explicit exception records.
- Exceptions require owner, risk level, and expiration date.
