...
## Purpose
Production-grade guidance for architecture review in the Vibestack ecosystem.

## Scope
This skills document is part of Vibestack, a universal context operating system for AI engineering. It provides deterministic guidance for architecture review.
...
## Skill Interface
- Inputs: objective, constraints, relevant modules.
- Outputs: plan, implementation/review artifact, verification evidence.
- Exit criteria: measurable outcome and documented residual risk.
