...
## Purpose
Production-grade guidance for token optimization in the Vibestack ecosystem.

## Scope
This skills document is part of Vibestack, a universal context operating system for AI engineering. It provides deterministic guidance for token optimization.
