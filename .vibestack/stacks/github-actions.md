...
## Scope
This stacks document is part of Vibestack, a universal context operating system for AI engineering. It provides deterministic guidance for github actions.
...
## Adapter Model
- Isolate provider-specific SDK concerns.
- Expose neutral interfaces for orchestration.
- Keep migration and rollback paths explicit.
